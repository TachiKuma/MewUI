...
public abstract class LegacySingleLineTextBase : LegacyTextBase
{
    ...
    /// <summary>
    /// Copies document text into the buffer. Override to transform text (e.g., password masking).
    /// </summary>
    protected virtual void CopyDocumentTo(char[] buffer, int start, int length)
